...
| [CIFAR-100 Classification Experiments](https://github.com/yongjiang-niuniu/cifar-100) | ResNet and Vision Transformer classification notebooks, repaired ResNet-50 workflow, preserved original experiments, and offline checks | Python, PyTorch, torchvision, Jupyter | ResNet-50 offline execution checked on generated images; historical metrics are qualified separately |
| [Electric Vehicle Routing Research](projects/evrp.md) | Research report comparing genetic algorithms, simulated annealing, and ant colony optimization under load and battery constraints | Combinatorial optimization, local search, feasibility analysis | PDF and editable report source archived; early Python snapshots recovered locally, attribution and final-version match pending |
